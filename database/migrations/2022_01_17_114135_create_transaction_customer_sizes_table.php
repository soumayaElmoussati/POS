...
class CreateTransactionCustomerSizesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transaction_customer_sizes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('transaction_customer_sizes');
    }
}
